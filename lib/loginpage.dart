          ...
          children: [
           ...
           Row(mainAxisAlignment: MainAxisAlignment.end,
            children: [
               Padding(
                 ...
                 child: Text('Forget your password?',style: TextStyle(fontWeight:FontWeight.bold,fontFamily: 'roboto',fontSize: 12,color:const Color.fromARGB(255, 16, 34, 193)),),
               )
            ],
           ),
           SizedBox(height: 20,),
           ...
           child: Container(
            ...
            child:Row(
              ...
              children: [
                Text('Sign in',style: TextStyle(color:Colors.white,fontSize: 18,fontWeight: FontWeight.bold,fontFamily: 'Roboto'),),
              ],
            )
           ),
           ),
